...
pub(crate) fn apply_start_of_combat_modules(
    ...
    for &module in modules {
        match module {
            ModuleId::AegisDrive => {
                combat.player.fighter.block = combat.player.fighter.block.saturating_add(5);
                applied.push(module);
            }
            ModuleId::TargetingRelay => {
                combat.player.fighter.statuses.focus = combat
                    .player
                    .fighter
                    .statuses
                    .focus
            ...
            ModuleId::CapacitorBank => {
                combat.player.fighter.statuses.momentum = combat
                    .player
                    .fighter
                    .statuses
                    .momentum
            ...
            ModuleId::OverclockCore => {
                combat.player.max_energy = combat.player.max_energy.saturating_add(1);
                combat.player.energy = combat
                    .player
                    .energy
                    .saturating_add(1)
                    .min(combat.player.max_energy);
                applied.push(module);
            }
